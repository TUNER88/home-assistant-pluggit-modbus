...
from custom_components.integration_blueprint.api import PluggitVentilationApiClient
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = PluggitVentilationApiClient("test", "test", async_get_clientsession(hass))
